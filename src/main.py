...
import src.group_class as gc
import src.analyze_functions as func
import src.reply_functions as repl
import time
import random
import math
...
while run:
    ...
    if code == 3:
        ...
        if not have_a_task or current_user_id == master_id:
            ...
            repl.not_available_i_am_busy(current_user_id)
    elif code == 2:
        ...
        repl.send_big_instruction(current_user_id)
    elif code == 10:
        repl.task_by_button(current_user_id)
    elif code == 11:
        ...
        if have_a_task and current_user_id == master_id:
            ...
            not repl.not_available_i_am_busy(current_user_id)
    elif code == 13:
        if have_a_task and current_user_id == master_id:
            r_id = func.get_new_random_id()
